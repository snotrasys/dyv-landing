...
import { ArrowLeftIcon, ArrowSmallUpIcon } from '@heroicons/react/20/solid';
...
function ModalUp({
  ...
  useEffect(() => {
      ...
      const newBalance = BigNumber.from(currentBalance).mul(value).div(100).toString();
      setbalance(
      ...
      <div>
        <div className="mt-7">
          ...
          <div className="mt-2">
            ...
            >
              Balance:{ethers.utils.formatEther(currentBalance)} XMB
            </p>
          </div>
        </div>
